  ...
  return (
    <>
      <style>{`
        ...
        .ftr {
          background:#1A1626; padding:5rem 0 2.5rem;
          border-top:2px solid rgba(196, 176, 232, 0.25);
        ...
        .ftr::before {
          ...
          background:linear-gradient(90deg,transparent,#9b7fd4,#c4b0e8,#9b7fd4,transparent);
        }
        ...
        .ftr-blob2 {
          ...
          border-radius:50%; pointer-events:none;
          background:radial-gradient(circle,rgba(212, 160, 192, 0.07) 0%,transparent 70%);
        }
          ...
          <div className="ftr-top">
            ...
            <div>
              ...
              <ul className="ftr-links">
                ...
                <li><a href="/admin/login" className="ftr-link">Admin Portal</a></li>
              </ul>
            </div>
